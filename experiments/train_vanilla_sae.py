...
from saefty.models.sae.vanilla import VanillaSAE, VanillaConfig
...
def parse_args():
    ...
    parser.add_argument("--lang", type=str, default="en,ar,hi")
    parser.add_argument("--dataset", type=str, default="CohereForAI/aya_dataset")
    parser.add_argument("--output-dir", type=str, default="results/train_sae/vanilla")
...
def main():
    ...
    print(f"SAE: {sae.d_model} → {sae.d_sae} features, "
